...
<body>
    ...
    <!-- navigation -->
      ...
      if($debut > 6){
        ?>
        <a href="location.php?recherche=<?php echo $recherche;?>&amp;nb=<?php echo $debut-7;?>" class="btn btn-default">Elements précédents</a>
      <?php
      }
      ...
      if($test -> fetch()){ ?>
        <a href="location.php?recherche=<?php echo $recherche;?>&amp;nb=<?php echo $debut+7;?>" class="btn btn-default">Elements suivants</a>
      <?php
      }
